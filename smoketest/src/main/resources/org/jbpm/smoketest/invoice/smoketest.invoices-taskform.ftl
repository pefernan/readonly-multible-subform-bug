<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					...
					i++;
					myInputs[i] = document.getElementById("total");
					i++;
...
<div id="container">
	<div id="header">
		New Process Instance: /smoketest/src/main/resources/org/jbpm/smoketest/invoice.invoices
	</div>
	<div id="content">
		...
		<fieldset>
            <legend>Process inputs</legend>
                            		...
                            		<div class="div_texbox">
                              		<input name="total" type="text" class="textbox" id="total" value="" />
                            		</div>
